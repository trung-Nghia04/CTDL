...
public class Test {
	public static void main(String[] args) {
		...
		QuanLyAnPham dm1 = new QuanLyAnPham();
		dm1.themAnPham(s1);
		dm1.themAnPham(s2);
		dm1.themAnPham(s3);
		dm1.themAnPham(tc1);
		...
		System.out.println(s1.layTenAnPham());
		...
		System.out.println(dm1.cungloaiTacGia(tc3, tc1));
		...
		System.out.println(dm1.dsTapChiTrongNam(2010));
		System.out.println(
		...
		Map<Integer, Long> re = dm1.thongKeSoLuongAnPhamTheoNamXuatBan();
